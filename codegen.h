...
codegen_func
	...
	gen_case, gen_compound, gen_cond, gen_const, gen_defs,
	gen_div, gen_div_assign, gen_eq, gen_eq_assign, gen_null,
	gen_extrn, gen_funcdef, gen_ge, gen_goto, gen_gt, gen_if,
	gen_index, gen_indir, gen_init, gen_inits, gen_or,
	gen_ivals, gen_label, gen_le, gen_left, gen_left_assign,
	gen_lt, gen_mod, gen_mod_assign, gen_mul, gen_mul_assign,
	gen_name, gen_names, gen_ne, gen_ne_assign, gen_neg, gen_not,
	...
	gen_switch, gen_switch, gen_vecdef, gen_while;
